...
1. **Baixe** o arquivo `PatientRegistration-v1.0.0-windows.zip` abaixo
...
> ⚠️ **IMPORTANTE**: Envie toda a pasta extraída, não apenas o arquivo .exe!

### 📊 Informações Técnicas

| Item | Detalhes |
|------|----------|
| **Tamanho Comprimido** | ~170 MB |
| **Tamanho Extraído** | ~377 MB |
...
- Esta é a primeira release oficial do sistema
